...
export default function LinkedInLoginButton({ minimal = false }: LinkedInLoginButtonProps) {
    ...
    if (minimal) {
        return (
            ...
            >
                {loading ? (
                    <div className="animate-spin rounded-full h-5 w-5 border-2 border-[#0a66c2]/30 border-t-[#0a66c2]" />
                ) : (
