...
export default function InterviewReportPage() {
    ...
    return (
        <div className="relative min-h-[calc(100vh-64px)] bg-slate-50 py-12 sm:py-20 overflow-hidden" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
            ...
            <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                <motion.button 
                    ...
                    className="mb-8 inline-flex items-center gap-2 rounded-full border border-[#E2E8F0] bg-white/80 backdrop-blur-sm px-5 py-2.5 text-sm font-bold text-[#475569] shadow-sm hover:bg-white hover:text-[#0F172A] hover:shadow transition-all group"
                >
                ...
                {loading ? (
                    ...
                    <div className="flex h-64 flex-col items-center justify-center rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm">
                        <h3 className="text-lg font-bold text-slate-900">No report available</h3>
                        <p className="mt-2 text-sm text-slate-500">Complete an interview session to generate a report.</p>
                        <button 
